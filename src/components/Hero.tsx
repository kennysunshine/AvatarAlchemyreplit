...
export function Hero() {
    return (
        <section className="relative pt-32 pb-20 overflow-hidden flex flex-col items-center text-center px-4">
            ...
            {/* Tagline Pill */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/20 bg-primary/5 text-primary text-xs font-medium mb-8 relative z-10">
            ...
            {/* Main Headline */}
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 max-w-4xl relative z-10">
                Stop Guessing. <br />
                <span className="text-gradient-primary">Start Trending.</span>
            </h1>

            {/* Subheadline */}
            <p className="text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed relative z-10">
            ...
            <div className="grid grid-cols-3 gap-12 md:gap-24 text-center relative z-10 w-full max-w-4xl mx-auto border-t border-white/5 pt-12">
                <div>
                    <h3 className="text-2xl font-bold text-primary mb-1">Get Found</h3>
                    <p className="text-sm text-gray-500 uppercase tracking-wider">AI Visibility</p>
                </div>
                <div>
                    <h3 className="text-2xl font-bold text-primary mb-1">Get Seen</h3>
                    <p className="text-sm text-gray-500 uppercase tracking-wider">Content Lab</p>
                </div>
                <div>
                    <h3 className="text-2xl font-bold text-primary mb-1">Scale</h3>
